...
export default function FeedbackPage() {
  ...
  return (
    <main className="h-screen w-full bg-[#020202] text-white overflow-hidden flex flex-col items-center justify-center p-6 md:p-12">
      ...
      <div className="relative z-10 w-full max-w-5xl h-full max-h-[800px] flex flex-col">
        <div className="flex-none mb-6 flex items-center justify-between">
          <div className="space-y-1">
            <h1 className="text-xl font-light text-zinc-300">Session Report</h1>
